...
export default function CreateCoursePage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // update endpoints usually return 200 — accept both 200 and 201
                        ...
                        <Card className="shadow-sm">
                            <CardHeader className="bg-[#313D6A] py-2 text-white">
                                ...
                                <CardDescription className="text-gray-200">
                                    Fill in the details to edit your course
                                </CardDescription>
                            </CardHeader>
                            ...
                            <CardContent className="p-6">
                                <div className="space-y-4">
                                    ...
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center space-x-2">
                                            <span
                                                className={`px-2 py-1 rounded-full text-xs font-medium ${formData.courseType === "free"
